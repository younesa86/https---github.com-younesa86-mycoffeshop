          ...
          <FlatList
            ...
            renderItem={({item}) => (
              <View>
                ...
                <Text style={styles.textinfo}>
                  {item.location.location_name} {item.location.location_id}{' '}
                ...
                <Text style={styles.textinfo}>
                  OverallRating:{' '}
                  {Math.round(item.review.overall_rating * 10) / 10}
                </Text>
                <Text style={styles.textinfo}>
                  {' '}
                  Price Rating: {Math.round(item.review.price_rating * 10) / 10}
                </Text>
                <Text style={styles.textinfo}>
                  Quality Rating:{' '}
                  {Math.round(item.review.quality_rating * 10) / 10}
                </Text>
                <Text style={styles.textinfo}>
                  Clenliness Rating:{' '}
                  {Math.round(item.review.clenliness_rating * 10) / 10}
                </Text>
                <Text style={styles.textinfo}>
